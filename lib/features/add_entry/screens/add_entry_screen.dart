...
class _AddEntryScreenState extends State<AddEntryScreen> {
                ...
                child: Column(
                  children: [
                    ...
                    AppTextFormField(
                      ...
                      onChanged: (value) {
                        // Check if a valid customer is selected before fetching vehicles
                        if (_controller.selectedCustomerCode.value.isNotEmpty) {
  ...
  Row _fuelAndOtherButton(BuildContext context) {
    return Row(
      ...
      children: [
        Obx(
          () => AppSecondaryButton(
                                ...
                                AppSecondaryButton(
                                  onPressed: () {
                                    ...
                                    double qty = double.tryParse(
                                            _controller.fuelController.text) ??
                                        0.0;
                                    if (qty > 0) {
                                      _controller.addItem(
                                        iName:
            ...
            buttonColor:
                _controller.isFuelAdded.value ? kColorLightGrey : kColorPrimary,
            title: 'Fuel',
            icon: kIconFuel,
          ),
        ),
                      ...
                      children: [
                        ...
                        AppSecondaryButton(
                          onPressed: () {
                            ...
                            if (qty > 0) {
                              _controller.addItem(
                                iName: _controller.otherItemController.text,
                                qty: qty,
                              );
                              Get.back();
                            }
  ...
  AppButton _saveButton() {
    return AppButton(
      onTap: () {
        ...
        if (_controller.customerNameController.text.isNotEmpty &&
            _controller.vehicleNoController.text.isEmpty) {
          showErrorSnackbar(
            'Oops',
